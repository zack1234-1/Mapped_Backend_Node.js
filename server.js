...
// Import the recommendation routes
const recommendationRoutes = require('./routes/sessionRecommendationRoutes');

// Register the routes (make sure asyncHandler is defined)
app.use('/api/recommendations', recommendationRoutes(asyncHandler));
